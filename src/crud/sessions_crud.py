...
from src.utils.validators import validate_exists_session_by_room_id_and_times
    ...
    def insert_session(self, data: Dict[str, Any]) -> Optional[str]:
        try:
            ...
            if start_date and start_time:
                ...
                if not validate_exists_session_by_room_id_and_times(room_id, start_date.isoformat(), start_time.strftime('%H:%M:%S')):
                    raise ValueError(
